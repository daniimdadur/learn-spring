...
import bootcampjavapamarican.spring.core.service.AuthService;
...
public class AwareTest {
    ...
    void testAware() {
        ...
        Assertions.assertEquals("bootcampjavapamarican.spring.core.service.AuthService",authService.getBeanName());
